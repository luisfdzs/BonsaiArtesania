...
/**
 * La página del taller es la lista de pedidos, y no es barata: además de traer
 * los cien últimos, cuenta cuántos hay en cada estado para los filtros. Son dos
 * viajes a Atlas, uno de ellos una agregación.
 *
 ...
 * porque al taller no se llega desde ningún enlace de la barra: se entra
