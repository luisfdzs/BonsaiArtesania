...
/**
 * Las cuatro secciones de la cuenta. Cliente por una sola razón: `usePathname`,
 * que es lo que permite encender la pestaña en la que se está. Antes eran cuatro
    ...
    <nav aria-label="Secciones de tu cuenta">
      <ul className="flex flex-wrap justify-center gap-x-2 gap-y-1">
        {items.map(({ href, label, Icon }) => {
          ...
          // se quedaría encendida en las cuatro pestañas.
