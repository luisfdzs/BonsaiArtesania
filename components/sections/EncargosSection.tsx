  ...
  return (
    <section id="encargos" className="page-gutter pt-(--spacing-section)">
      ...
      <header className="mx-auto max-w-2xl text-center">
        ...
        {/* Era el `<h1>` de la página de encargos; en la portada el titular de la
            página es el del hero, así que aquí baja un nivel y se queda con el
            tamaño, que es lo que hacía el trabajo. */}
      ...
      <div className="mt-(--spacing-section)">
        ...
        {/* Dos filas de dos y no cuatro en fila —ni cuatro apilados en móvil—: los
            cuatro pasos son dos parejas, lo que haces tú y lo que hago yo, y en
            una tira de cuatro columnas cada paso quedaba tan estrecho que el
            texto se partía en cinco líneas. En cuadro se leen de un vistazo a
            cualquier ancho. El hueco lateral crece con la pantalla: a 360px cada
            píxel de aire entre columnas se lo quita a las palabras. */}
        <ol className="mx-auto mt-12 grid max-w-4xl grid-cols-2 items-start gap-x-6 gap-y-12 sm:gap-x-10 lg:gap-x-16">
